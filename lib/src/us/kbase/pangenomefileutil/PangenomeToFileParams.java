...
public class PangenomeToFileParams {
    ...
    public PangenomeToFileParams withSaveToShock(Long saveToShock) {
        this.saveToShock = saveToShock;
        return this;
    }
    ...
    public String toString() {
        return ((((((((("PangenomeToFileParams"+" [pangenomeName=")+ pangenomeName)+", workspaceName=")+ workspaceName)+", saveToShock=")+ saveToShock)+", additionalProperties=")+ additionalProperties)+"]");
    }
